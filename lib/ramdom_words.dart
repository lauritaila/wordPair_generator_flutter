// ignore_for_file: use_key_in_widget_constructors, prefer_const_constructors, unused_local_variable, annotate_overrides, prefer_collection_literals
...
class RamdomWordsState extends State<RamdomWords> {
  final _ramdomWordPairs = <WordPair>[];
  ...
  Widget _buildList() {
    return ListView.builder(
        ...
        itemBuilder: (context, item) {
          ...
          final index = item ~/ 2;
          if (index >= _ramdomWordPairs.length) {
            _ramdomWordPairs.addAll(generateWordPairs().take(10));
          }

          return _buildRow(_ramdomWordPairs[index]);
        });
  }
